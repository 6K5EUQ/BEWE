...
Byte-identical copy of ais_ai/model.py. Duplicated on purpose: BEAE modules are
independent sale/removal units, so amc must not break when BEAE/ais is deleted.
If you change the architecture here, the AMC checkpoints stop loading — retrain.
"""
import torch
