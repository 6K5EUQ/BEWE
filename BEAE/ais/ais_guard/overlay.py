...
def _demo_items(cfg):
    ...
    # 1) 충돌위험: 진해만 수역 스트립(35.11N) 동서 상호 접근, 교점 = (35.1104, 128.6430)
    a = [(35.1080 + 0.0004 * i, 128.6130 + 0.0050 * i) for i in range(5)]   # 동진
    b = [(35.1128 - 0.0004 * i, 128.6730 - 0.0050 * i) for i in range(6)]   # 서진
    it.append(("path", 999000001, "DEMO-A", a))
    it.append(("path", 999000002, "DEMO-B", b))
    it.append(("alert", 1, 3, 999000001, 999000002, 35.1104, 128.6430, 92.0, 140.0, 210.0,
    ...
    # 3) 이상항적: 남측 개활수역(35.03N 128.61E) 갈지자
    d = [(35.030, 128.596), (35.037, 128.604), (35.029, 128.611), (35.038, 128.618),
         (35.030, 128.624), (35.039, 128.630), (35.031, 128.636), (35.036, 128.628)]
